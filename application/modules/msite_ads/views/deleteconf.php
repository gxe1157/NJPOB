	...
	<div class="box span12">
		<div class="box-header" data-original-title>
			...
			<div class="box-icon">
				...
				<a href="<?= base_url() ?>msite_ads/manage" ><i class="halflings-icon white remove"></i></a>
			</div>
		</div>
		<div class="box-content">
			...
			<?php echo form_open_multipart('msite_ads/delete/'.$update_id, array('class' => 'form-horizontal') ); ?>
			  	<fieldset>
